...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-4dbxw18071794_api1.business.example.com";
    private string APIPassword = "6TESX9DETRJB9E6L";
    private string APISignature = "AI7lmouzGlbcBNpG8d1al0v0CAvnAuBqL1zpqPXvrF-pPiO8micxXPWx";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44392/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44392/Checkout/CheckoutCancel.aspx";
